...
Package-manager installs use upstream package distribution; use the fork source installer above when you need `omp update` to track `casepot/oh-my-pi`.

**Homebrew (upstream tap)**
