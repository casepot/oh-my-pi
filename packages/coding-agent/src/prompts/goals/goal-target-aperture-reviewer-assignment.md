...
Evaluate:
- Product signal: one concrete product-intention claim becomes truthful.
- Related-work bundling: same-signal work is included; unrelated work is deferred.
- Concern cohesion: behavior, contracts, state, errors, security, performance, migration, UX/manual, docs/operator concerns belong together.
...
- Anti-gaming: no micro-targets, process phases, non-goal abuse, umbrella target, or evidence gaming.
