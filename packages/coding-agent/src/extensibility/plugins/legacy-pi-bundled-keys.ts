...
export const BUNDLED_PI_REGISTRY_KEYS: ReadonlySet<string> = new Set([
	...
	"@oh-my-pi/pi-coding-agent/project-detection",
	...
	"@oh-my-pi/pi-coding-agent/capability/skillset",
	...
	"@oh-my-pi/pi-coding-agent/discovery/skillsets",
	...
	"@oh-my-pi/pi-coding-agent/export/ttsr-paths",
	...
	"@oh-my-pi/pi-coding-agent/modes/rpc/rpc-protocol",
	...
	"@oh-my-pi/pi-coding-agent/task/runtime-policy",
