...
export type NewGoalStateSnapshotInput = GoalStateSnapshotEntry extends infer Entry
	? Entry extends GoalStateSnapshotEntry
		? Omit<Entry, keyof SessionEntryBase | "type">
		: never
	: never;
