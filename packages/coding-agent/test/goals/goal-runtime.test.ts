				...
				results: [
					{
						...
						termination: {
							status: "completed",
							code: "yielded",
							reason: "Backend task yielded a result",
							resumable: false,
							historyUri: "history://BackendAgent",
							outputUri: "agent://BackendAgent",
							policy: {
					...
					},
					{
						...
						termination: {
							status: "completed",
							code: "yielded",
							reason: "UI task yielded a result",
							resumable: false,
							historyUri: "history://UiAgent",
							outputUri: "agent://UiAgent",
							policy: {
								request: { termination: "disabled", advisory: { mode: "off", afterAssistantTurns: null } },
								wallClock: { maxRuntimeMs: null },
								stall: { action: "off", afterAssistantTurns: null },
