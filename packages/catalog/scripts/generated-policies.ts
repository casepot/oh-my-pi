/**
 * Generation-time catalog policies: upstream metadata corrections and derived
 * field baking. Runs only from `generate-models.ts` — none of this ships in the runtime bundle.
 */
