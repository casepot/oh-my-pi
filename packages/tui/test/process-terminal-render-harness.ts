...
// headroom keeps non-resize scheduler-driven paints deterministic without
// tripping the 150 ms kitty fallback timer during startup probes.
const SETTLE_MS = 67;
// The non-multiplexer resize path paints a transient viewport immediately and
// replays the authoritative full frame after the 120 ms drag-settle window.
// Wait past that window for geometry-affecting input.
